...
public class KinectWrapper
{
	...
	public static bool CheckOpenNIPresence()
	{
		...
		string sOpenNIPath =System.Environment.GetEnvironmentVariable("OPENNI2_REDIST");// Environment.CurrentDirectory+"/Plugins/OpenNI/";// 
		...
		string sNiTEPath = System.Environment.GetEnvironmentVariable("NITE2_REDIST");//Environment.CurrentDirectory+"/Plugins/NITE/";//
